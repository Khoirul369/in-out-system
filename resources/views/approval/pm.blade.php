...
<div class="page-head">
  <div>
    <div class="page-title">Approval PM</div>
    <div class="page-sub">Pengajuan resign bawahan yang menunggu persetujuan PM.</div>
  </div>
</div>

<div class="card">
  <div class="card-title">Menunggu Approval <span class="badge badge-pending approval-badge-gap">{{ $pending->count() }}</span></div>
  @if($pending->isEmpty())
    <div class="empty-state">Tidak ada pengajuan yang perlu di-approve.</div>
  @else
